...
class _CategoriesPage extends State<Categories> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 237, 234, 228),
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 128, 240, 173),
        leading: IconButton(
          onPressed: () {
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 25,
                color: Color.fromARGB(220, 16, 1, 9),
        ...
        Padding(
          ...
          child: Container(
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(20), color: Color.fromARGB(255, 126, 228, 155)),
            height: 250,
